...
//			public void run() {
//				try {
//					FileInputGUI frame = new FileInputGUI();
	...
	public FileInputGUI() {
		...
		btnBrowse.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				FileNameExtensionFilter filter = new FileNameExtensionFilter("PNG Image",
				        "png");
				...
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_contentPane.createSequentialGroup()
							...
							.addGap(24))
						.addGroup(gl_contentPane.createSequentialGroup()
							.addComponent(lblChooseAnInput, GroupLayout.PREFERRED_SIZE, 219, GroupLayout.PREFERRED_SIZE)
